...
export const TITLES: Record<string, string> = {
  ...
  '/calculators': `Free Fitness Calculators — BMI, Calorie, Nutrition & More${TITLE_SUFFIX}`,
  '/calorie-calculator': `Calorie Calculator — Safe Daily Deficit for Weight Loss${TITLE_SUFFIX}`,
  '/bmi-calculator': `BMI Calculator — Check Your Body Mass Index in Seconds${TITLE_SUFFIX}`,
  '/nutrition-calculator': `Nutrition Calculator — Protein, Carbs & Fat Targets${TITLE_SUFFIX}`,
  '/ideal-weight-calculator': `Ideal Weight Calculator — Devine, Robinson & Hamwi Formulas${TITLE_SUFFIX}`,
  '/body-fat-calculator': `Body Fat Calculator — Estimate Your Body Fat Percentage Free${TITLE_SUFFIX}`,
  '/protein-calculator': `Protein Calculator — Optimal Daily Protein for Women${TITLE_SUFFIX}`,
...
export const DESCRIPTIONS: Record<string, string> = {
  ...
  '/calculators': 'Use our free fitness calculators to track your health metrics. BMI, calorie, nutrition, ideal weight, body fat, protein, TDEE, BMR, and water intake calculators.',
  '/calorie-calculator': 'Set a safe calorie target for weight loss and see your daily calorie deficit in seconds. Free tool for women.',
  '/bmi-calculator': 'Check your BMI and see what your body mass index means for your health. Free BMI calculator for women.',
  '/nutrition-calculator': 'Get your personalized protein, carb, and fat targets with a free nutrition calculator built for women.',
  '/ideal-weight-calculator': 'See your healthy weight range using 4 science-backed formulas. Includes BMI range. Free calculator for women.',
  '/body-fat-calculator': 'Calculate your body fat % with categories from essential to overweight. A better health marker than scale weight alone.',
  '/protein-calculator': 'Calculate your daily protein grams based on weight and activity level. Preserve muscle and stay full. Free tool.',
